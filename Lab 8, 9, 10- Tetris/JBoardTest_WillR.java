...
class JBoardTest_WillR extends JComponent {
	...
	private int pieceX;
	private int pieceY;
	private final boolean SHOW_COLORS = false;
	
	public JBoardTest_WillR(int width, int height) {
		super();
	...
	*/
	...
	
	{
		...
		JBoardTest_WillR bt = new JBoardTest_WillR(200, 300);
